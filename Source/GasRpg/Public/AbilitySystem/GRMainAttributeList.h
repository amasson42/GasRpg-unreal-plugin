...
#define FOREACH_ATTRIBUTE_Primary(FunctionExpression) \
    ...
    FunctionExpression(Valor, Primary) \
    FunctionExpression(Intelligence, Primary) \
    FunctionExpression(Wisdom, Primary) \
    FunctionExpression(Divinity, Primary) \

#define FOREACH_ATTRIBUTE_Secondary(FunctionExpression) \
    FunctionExpression(PhysicalDefense, Secondary) \
    FunctionExpression(SpellDefense, Secondary) \
    FunctionExpression(MovementSpeed, Secondary) \
    FunctionExpression(MeleeAttack, Secondary) \
    FunctionExpression(RangedAttack, Secondary) \
    FunctionExpression(SpellAttack, Secondary) \
    FunctionExpression(BlockBonus, Secondary) \
